...
text.files <- list.files(
  path = "./data-raw/SentenceCorpus/labeled_articles",
  pattern = "\\.txt",
  recursive = T,
  full.names = T
)

stop_words_sentences <- readLines(
  "./data-raw/SentenceCorpus/word_lists/stopwords.txt"
)
